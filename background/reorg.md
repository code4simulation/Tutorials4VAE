...
1.  [서론: 확률론적 생성 모델 VAE](#1-서론-확률론적-생성-모델-VAE)
    ...
    *   1.2. [VAE 모델의 작동 원리](#12-vae-모델의-작동-원리)
2.  [수학적 배경](#2-수학적-배경)
